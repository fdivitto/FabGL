...
*
* VGA4Controller output is very CPU intensive process and consumes up to 25% of one CPU core (measured at 640x480x60Hz). Anyway this allows to have
...
*/
class VGA4Controller : public VGABaseController {
...
private:
  ...
  volatile uint8_t *          m_lines[VGA4_LinesCount];
