...
*
* VGA8Controller output is very CPU intensive process and consumes up to 26% of one CPU core (measured at 640x480x60Hz). Anyway this allows to have
...
*/
class VGA8Controller : public VGABaseController {
...
public:
  ...
  // abstract method of BitmappedDisplayController
  NativePixelFormat nativePixelFormat()               { return NativePixelFormat::PALETTE4; }
...
private:
  ...
  volatile uint8_t *          m_lines[VGA8_LinesCount];
