...
public:
   ...
   */
  void setupAbsolutePositioner(int width, int height, bool createAbsolutePositionsQueue, VGAController * updateDisplayController = nullptr, uiApp * app = nullptr);
...
private:
  ...
  VGAController * m_updateDisplayController;
