...
//============================================================================
// 2019: Adaptations to a personal project by Fabrizio Di Vittorio
// 2019: Cycle exact counting
// 2019: Some undocumented 6502 instructions
...
private:
  ...
  void Op_INS(uint16_t src);
	...
	typedef void (*BusWrite)(void * context, uint16_t, uint8_t);
	typedef uint8_t (*BusRead)(void * context, uint16_t);
	BusRead Read;
	BusWrite Write;
...
public:
	...
	mos6502(BusRead r, BusWrite w, void * context);
	int NMI();
	int IRQ();
	int Reset();
	int Run();
