...
void loop()
{
  ...
  Machine machine;
  machine.setRAMExpansion(RAM_3K);
      ...
      switch (vk) {
        ...
        case VirtualKey::VK_F12:
          if (!keyDown)
            ...
            //machine.loadPRG(cosmicfirebirds, sizeof(cosmicfirebirds), true);
            machine.loadPRG(tetrisdeluxe, sizeof(tetrisdeluxe), true);
          break;
        default:
...
// 1311000 - 1311000 (game 961000-965000)
